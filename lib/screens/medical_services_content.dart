...
class MedicalServicesContent extends StatefulWidget {
  const MedicalServicesContent({Key? key}) : super(key: key);
      ...
      if (result['success'] && result['data'] != null) {
        ...
        if (specialtyList.isNotEmpty) {
          ...
          setState(() {
            specialties = [];
            loading = false;
            errorMsg = 'No API data available';
          });
        }
      } else {
        setState(() {
          specialties = [];
          loading = false;
          errorMsg = 'API failed to load data';
        });
      }
    } catch (e) {
      print('Error: $e');
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                selectedSpecialty!.description.isNotEmpty 
